...
/**
	 ...
	 * @license
	 */
var gt=e&&e.__createBinding||(Object.create?function(e,t,s,n){void 0===n&&(n=s);var r=Object.getOwnPropertyDescriptor(t,s);r&&!("get"in r?!t.__esModule:r.writable||r.configurable)||(r={enumerable:!0,get:function(){return t[s]}}),Object.defineProperty(e,n,r)}:function(e,t,s,n){void 0===n&&(n=s),e[n]=t[s]}),ft=e&&e.__setModuleDefault||(Object.create?function(e,t){Object.defineProperty(e,"default",{enumerable:!0,value:t})}:function(e,t){e.default=t}),vt=e&&e.__importStar||function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var s in e)"default"!==s&&Object.prototype.hasOwnProperty.call(e,s)&&gt(t,e,s);return ft(t,e),t};Object.defineProperty(t,"__esModule",{value:!0});const yt=vt(s),xt=C,bt=w,Ct=at,wt=T,_t=we,It=pt,St=async function(){return new Promise((e=>{window.setSelfTargetId=t=>{(0,It.log)(wt.LogType.system,"Current target ID:",t),e(t)}}))}();(async()=>{(0,It.generatePage)();const e=await St,t=await function(e){class t{#mt=null;constructor(){window.onBidiMessage=e=>{let s;(0,It.log)(wt.LogType.bidi,"received ◂",e);try{s=t.#ft(e)}catch(t){return void this.#vt(e,xt.Message.ErrorCode.InvalidArgument,t.message,null)}this.#mt?.call(null,s)}}setOnMessage(e){this.#mt=e}sendMessage(e){const t=JSON.stringify(e);window.sendBidiResponse(t),(0,It.log)(wt.LogType.bidi,"sent ▸",t)}close(){this.#mt=null,window.onBidiMessage=null}#vt(e,s,n,r){const a=t.#yt(e,s,n);r?this.sendMessage({...a,channel:r}):this.sendMessage(a)}static#xt(e){return null===e?"null":Array.isArray(e)?"array":typeof e}static#yt(e,s,n){let r;try{const s=JSON.parse(e);"object"===t.#xt(s)&&"id"in s&&(r=s.id)}catch{}return{id:r,error:s,message:n}}static#ft(e){let s;try{s=JSON.parse(e)}catch{throw new Error("Cannot parse data as JSON")}const n=t.#xt(s);if("object"!==n)throw new Error(`Expected JSON object but got ${n}`);const{id:r,method:a,params:i}=s,o=t.#xt(r);if("number"!==o||!Number.isInteger(r)||r<0)throw new Error(`Expected unsigned integer but got ${o}`);const d=t.#xt(a);if("string"!==d)throw new Error(`Expected string method but got ${d}`);const c=t.#xt(i);if("object"!==c)throw new Error(`Expected object params but got ${c}`);let u=s.channel;if(void 0!==u){const e=t.#xt(u);if("string"!==e)throw new Error(`Expected string channel but got ${e}`);""===u&&(u=void 0)}return{id:r,method:a,params:i,channel:u}}}return bt.BidiServer.createAndStart(new t,function(){class e{#mt=null;constructor(){window.cdp.onmessage=e=>{this.#mt?.call(null,e)}}setOnMessage(e){this.#mt=e}sendMessage(e){window.cdp.send(e)}close(){this.#mt=null,window.cdp.onmessage=null}}return new Ct.CdpConnection(new e,((...e)=>{(0,It.log)(wt.LogType.cdp,...e)}))}(),e,new Et,It.log)}(e);(0,It.log)(wt.LogType.system,"Launched"),t.emitOutgoingMessage(_t.OutgoingBidiMessage.createResolved({launched:!0},null))})();class Et{parseAddPreloadScriptParams(e){return yt.Script.parseAddPreloadScriptParams(e)}parseRemovePreloadScriptParams(e){return yt.Script.parseRemovePreloadScriptParams(e)}parseGetRealmsParams(e){return yt.Script.parseGetRealmsParams(e)}parseCallFunctionParams(e){return yt.Script.parseCallFunctionParams(e)}parseEvaluateParams(e){return yt.Script.parseEvaluateParams(e)}parseDisownParams(e){return yt.Script.parseDisownParams(e)}parseSendCommandParams(e){return yt.CDP.parseSendCommandParams(e)}parseGetSessionParams(e){return yt.CDP.parseGetSessionParams(e)}parseSubscribeParams(e){return yt.Session.parseSubscribeParams(e)}parseNavigateParams(e){return yt.BrowsingContext.parseNavigateParams(e)}parseGetTreeParams(e){return yt.BrowsingContext.parseGetTreeParams(e)}parseCreateParams(e){return yt.BrowsingContext.parseCreateParams(e)}parseCloseParams(e){return yt.BrowsingContext.parseCloseParams(e)}parseCaptureScreenshotParams(e){return yt.BrowsingContext.parseCaptureScreenshotParams(e)}parsePrintParams(e){return yt.BrowsingContext.parsePrintParams(e)}}return t}();
